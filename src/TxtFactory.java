...
public class TxtFactory implements FileFactory{
    ...
    public TxtFactory(File dataFile, File configFile) {
    ...
    @Override
    public void readDataToArray(File dataFile, File configFile) {
        String [] rowElements;
        try {
    ...
    public void saveFile(String fileName) {
        try {
            FileWriter fileToSave = new FileWriter(fileName + ".txt");
